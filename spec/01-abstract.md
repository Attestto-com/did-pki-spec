...
**Status:** Draft
**Method Name:** `pki`
**DID Method Specification:** [W3C DID Core v1.1](https://www.w3.org/TR/did-core/)
...
- **Verifiable provenance.** Every DID Document includes cryptographic proof linking it to the original X.509 certificate, enabling verifiers to independently confirm the mapping.
